...
nm -gU "$staged_core" | grep -q _rdn_client_file_transfer_manifest_root
nm -gU "$staged_core" | grep -q _rdn_client_file_transfer_download_start
nm -gU "$staged_core" | grep -q _rdn_client_file_transfer_upload_start
