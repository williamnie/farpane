...
def main() -> int:
    ...
    evidence = {
        ...
        "hostProductRichDirectionsRequireExplicitOptIn": (
            "clipboardRichTextReadEnabled:" in host_product
            and "clipboardRichTextWriteEnabled:" in host_product
            and ".allowRemoteRichTextRead" in host_product
            and ".allowRemoteRichTextWrite" in host_product
        ...
        "documentationRecordsViewerAndHostOptInBoundary": all(
            marker in docs
            for marker in (
    ...
    result = {
        ...
        "remainingBoundary": {
            ...
            "hostRichProductOptInRequired": False,
