...
def main() -> int:
    ...
    evidence = {
        ...
        "abiV11CarriesTwoCallbackScopedSemanticParts": all(
            marker in header
            for marker in (
    ...
    result = {
        ...
        "claims": {
            ...
            "viewerDownloadStartImplemented": False,
