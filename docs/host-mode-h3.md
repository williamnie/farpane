...
H3.3 仍未完成：Host 卡片尚未呈现/操作 active session，App rebuild、真实撤权 backlog、断开重连与 TCC/Aqua transition 还需最终 UI build 真机验收。新 core 未部署到 Mini，已安装版本保持不变。
