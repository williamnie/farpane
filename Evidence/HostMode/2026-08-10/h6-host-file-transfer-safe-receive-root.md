...
- H6.3e1 has since added the Native Host file-service owner, H6.3e3 connected
  safe mutations, and H6.3e4a added bounded new-file writes. Resume/overwrite,
  read/list and Viewer destination/progress UI remain absent.
...
configured its immutable root, H6.3e3 connected safe mutations, and H6.3e4a
added bounded new-file writes. Continue with
