...
/// coexist with the viewer ABI v11, export its full symbol surface, and fail
...
final class HostBridgeContractTests: XCTestCase {
    ...
    func testHostABISurfaceIsExportedAlongsideViewerABI() throws {
        ...
        XCTAssertEqual(viewerABI(), 11, "viewer ABI must expose the v11 manifest seam")
        XCTAssertNotNil(
    ...
    func testShimLoaderResolvesHostSurface() throws {
        ...
        XCTAssertEqual(rdn_shim_abi_version(shimLibrary), 11, "viewer ABI must expose v11")
